...
# the below function will take makeCacheMatrix as argument and will return inverted matrix
# either from cache, or will calculate it and set the value in cache for future function calls.
